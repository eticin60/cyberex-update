...
| :--- | :--- |
| **Frontend** | Native Android (Kotlin), Material 3, Custom Cyber-Neon UI |
| **Backend** | Google Firebase (Firestore, Functions, Auth, Messaging, Storage) |
| **AI Engine** | Google Generative AI (Gemini 2.0 Flash) |
| **APIs** | Binance API, CoinGecko API, OxaPay |
| **Architecture** | Clean Architecture, Coroutines, StateFlow, MVVM |
...
│   ├── src/main/java/      # Business Logic (Kotlin)
│   ├── src/main/res/       # Cyber-Neon UI Resources (XML)
│   └── build.gradle.kts    # Build Configuration
├── web3app/                # Web3 Mobile Application Portal
├── web3wallet/             # Decentralized Wallet Hub
├── web3extension/          # Browser Trading Extension
...
*   **Corporate Email**: [corporate@cyberex.com.tr](mailto:corporate@cyberex.com.tr)
*   **Support Email**: [contact@cyberex.com.tr](mailto:contact@cyberex.com.tr)

### Ecosystem Links
*   **Web3 Wallet**: [cyberex.com.tr/web3wallet](https://cyberex.com.tr/web3wallet)
*   **AnalyticaX**: [analyticax.com.tr](https://analyticax.com.tr)

---

<div align="center">
  <sub>CyberEx: Engineering the Future of Global Finance</sub><br>
  <sub>High-performance Systems • AI Intelligence • Blockchain Innovation</sub>
</div>
